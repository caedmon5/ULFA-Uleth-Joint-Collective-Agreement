   ...
   <xsl:template match="tei:add">
      <u>
         <xsl:attribute name="style">
            <xsl:choose>
               <xsl:when test="ancestor-or-self::*[@rend = 'new']">
                  <xsl:text>color:blue</xsl:text>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:text>color:inherit</xsl:text>
               </xsl:otherwise>
            </xsl:choose>
         </xsl:attribute>
         <xsl:apply-templates/>
...
-->
         ...
         <xsl:when test="parent::tei:list/parent::tei:body">
            ...
            <h2>
               ...
               <a>
                  ...
                  <xsl:attribute name="title"><xsl:value-of select="@sortkey"
                        /><xsl:text> - Click link to this item</xsl:text></xsl:attribute>
         ...
         <xsl:otherwise>
            <li>             
                  <xsl:attribute name="class">
                     <xsl:if test="child::tei:hi">head </xsl:if>
               ...
               <a class="articlenumber">
                  <xsl:attribute name="href">#<xsl:value-of select="@xml:id"/>
                  </xsl:attribute>
                  <xsl:attribute name="title"><xsl:value-of select="@sortkey"
                        /><xsl:text> - Click to get link to this item</xsl:text></xsl:attribute>
                  <xsl:value-of select="@n"/>
               </a>
               <xsl:text> </xsl:text>
               <xsl:apply-templates/>
   ...
   <xsl:template match="tei:body">
      <h1>
         <xsl:call-template name="docTitle"/> (display version) </h1>
   ...
   <xsl:template match="tei:teiHeader">
      <head>
         <title> Display Version (Full handbook) <xsl:call-template name="docTitle"/>
         </title>
         ...
         <style type="text/css" title="Default">
            ...
            li.fourth-level, li.fifth-level, li.sixth-level, li.seventh-level {
            text-indent: -1.5em;
            }
