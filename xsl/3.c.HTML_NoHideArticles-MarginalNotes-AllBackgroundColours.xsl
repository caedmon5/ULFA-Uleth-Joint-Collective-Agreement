...
-->
                  ...
                  <h2>
                     ...
                     <a>
                        ...
                        <xsl:choose>
                           ...
                           <xsl:otherwise>
                              <xsl:choose>
                                 <xsl:when test="../attribute::type='schedule'">Schedule
   ...
   <xsl:template match="tei:body">
      <h1>
         <xsl:call-template name="docTitle"/> (Articles on the table, with markup)
      </h1>
   ...
   <xsl:template match="tei:teiHeader">
      <head>
         <title> Articles on the Table with Markup and Marginal Notes <xsl:call-template name="docTitle"/>
         </title>
         ...
         <style type="text/css" title="Default">
            ...
            .movedText a[href]:link, .newText a[href]:link, .movedText a[href]:visited, .newText a[href]:visited {
           }
            .note a[href]:visited {
            color:gray;
            }
